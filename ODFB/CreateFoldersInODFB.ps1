<#
.Synopsis
   This script will create 2 folders into each users' ODFB provided in a CSV file.
.DESCRIPTION
   This script will create 2 folders into each users' ODFB provided in a CSV file and called FOLDER1 and FOLDER2, but you can add more if wanted.
...
.EXAMPLE
   .\CreateFoldersInODFB.ps1 -AdminAccount <admin@domain.com> -SPOAcct <SCA_on_ODFB> -TenantName <Name_of_the_O365_Tenant> -CsvFileLocation <CsvFile_Location> 
.EXAMPLE
